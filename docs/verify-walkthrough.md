...
| Enums | SceneId 0-5 real / 6-11 test; MusicTrack NONE0 OVERWORLD1 BATTLE2 VICTORY3 TITLE4 TOWN5 DUNGEON6 BOSS7 MIMIC8 DESOLATE9 FOREST10; flags bit-packed (N → byte (N-1)/8 bit (N-1)%8): ARRIVED_TOWN=1, MET_MAYOR=2; CURRENCY_ID_GOLD=1 → amount[0]; HERO_START gold=20 hp=10 |
