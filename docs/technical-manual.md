# KAARTENHELD — Technical Manual (as implemented)

> Looking for the friendly player's guide instead? See [`manual.md`](manual.md).

A complete, machine-checked reference to **KAARTENHELD — BATTLE DEMO**, the
