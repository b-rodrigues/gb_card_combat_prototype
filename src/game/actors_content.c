...
static const WorldActorDefinition g_field_actors[] = {
    {
        ...
        'E', "SLIME", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_SLIME_TRIO, AI_PATROL_CROSS, 10, 10, 5, CURRENCY_ID_GOLD, 0, 0,
         SPRITE_KIND_KOBOLD
    },
    {
...
static const WorldActorDefinition g_forest_actors[] = {
    {
        ...
        ACTOR_FLAG_HOSTILE | ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'E', "SLIME", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_SLIME, AI_PATROL_CROSS, 12, 12, 5, CURRENCY_ID_GOLD, 0, 0,
         SPRITE_KIND_KOBOLD
    },
    {
...
static const WorldActorDefinition g_mountain_pass_actors[] = {
    {
        ...
        ACTOR_FLAG_HOSTILE | ACTOR_FLAG_BLOCKING | ACTOR_FLAG_INTERACTABLE,
        'E', "SLIME", INTERACTION_COMBAT, 0, DIALOGUE_ID_NONE, BATTLE_SLIME_TRIO, AI_PATROL_CROSS, 16, 16, 5, CURRENCY_ID_GOLD, 0, 0,
         SPRITE_KIND_KOBOLD
    }
};
...
static const WorldActorDefinition g_castle_actors[] = {
     ...
     * quest is COMPLETE (the sword is in the inventory). */
    {
        ...
        VARIABLE_ID_QUEST_MONSTER_HUNT, 2, SPRITE_KIND_BOSS
    }
};
