...
const CardDefinition g_cards[] = {
    { CARD_IRON_SWORD,    CARD_TYPE_ATTACK,  3, 1,  0, 2, CARD_EFFECT_DAMAGE_TARGET, BATTLE_CARD_TYPE_SWORD,    10, "IRON SW" },
    { CARD_WOODEN_SHIELD, CARD_TYPE_DEFENSE, 2, 1,  0, 2, CARD_EFFECT_BLOCK_DAMAGE,  BATTLE_CARD_TYPE_SHIELD,    0, "WD SHLD" },
