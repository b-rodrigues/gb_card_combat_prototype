...
typedef enum {
    ...
    WORLD_TILESET_DUNGEON  = 3,
    WORLD_TILESET_HOUSES_WALLS    = 4,
    WORLD_TILESET_HOUSES_ROOFS    = 5,
    WORLD_TILESET_HOUSES_FLOORS   = 6,
    WORLD_TILESET_HOUSES_DOORS    = 7,
    WORLD_TILESET_HOUSES_WINDOWS  = 8,
    WORLD_TILESET_NATURE_GROUND   = 9,
    WORLD_TILESET_NATURE_VEGETATION = 10,
